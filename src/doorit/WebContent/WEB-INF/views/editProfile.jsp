									 ...
									 <div class="panel-body text-left">
											...
											<form:hidden value="${userId}" path="user.userId"></form:hidden>
 										         <div class="form-group"> 
                                           			 ...
                                           			 <form:input  type="text" required="required"  maxlength="50" class="form-control invalid" path="companyName" oninvalid="this.setCustomValidity('Please enter  company name')" oninput="setCustomValidity('')" />                                          
                                       			 </div>
                                       		 	<div class="form-group">
                                            		<label><b>Company website </b> </label>
                                            		<form:input  maxlength="100" class="form-control " path="website"/>                                          
                                       		 	</div>
                                        		<div class="form-group">
                                               		 <label><b>Company profile</b></label>
                                                	<form:textarea class="col-xs-12"   maxlength="500"    path="companyProfile" rows="4" cols="62" />
                                               </div>
                                            	<div class="form-group">
                                               		 <label><b> Address</b></label>
                                                	<form:input  maxlength="150"   path="user.address" class="form-control"  />
                                           	   </div>
                                              <div class="form-group">
