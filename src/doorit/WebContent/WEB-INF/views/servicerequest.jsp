    ...
    <div class="container"> 
      ...
      <label><input type="radio" checked id="emailOnly" name="optradio">I want quotes by email only</label>
                                         ...
                                         <div id="fullName" class="form-group">
                                            ...
                                            <form:input   maxLength="30"  class="form-control invalid" path="user.name" required="required" oninvalid="this.setCustomValidity('Please enter  name')" oninput="setCustomValidity('')"  />                                           
                                        </div>
                                        ...
                                        <%--    <div id="mobileVisible" >   
                                            ...
                                            <div class="form-group">
                                            	...
                                            	<form:input  maxlength="15"   type="password" class="form-control invalid" path="user.password" required="required"  oninvalid="this.setCustomValidity('Please enter passowrd')"  oninput="setCustomValidity('')"/>
                                       		</div>
