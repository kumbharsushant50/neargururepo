...
<section>
	...
	<div class="row">
		...
		<div class="col-md-4">
			<a href="${pageContext.request.contextPath}/admin/fetchVendors" class="btn  btn-danger ">Vendor Reports</a>
		</div>  
		<div class="col-md-4">
        ...
        <div class="row">    
            <div class="col-md-12 bg-color"> 
               <div class="container">
                   <h3 class=""> <a href="#" title=""></a><b> List of Vendors </b></h3>
               </div>
           </div>
		</div>
		 ...
		 <c:forEach var="reportObj" items="${reportList}"> 
				<div class="row">
						...
						<div class="col-md-2" style="word-wrap:break-word;word-break:break-all"> 
