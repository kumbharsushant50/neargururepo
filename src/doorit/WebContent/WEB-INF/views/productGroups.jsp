...
<html class='no-js' lang='en'>
    ...
    <head>
		...
		<title>NearGuru- List Your Business - Meet new customers</title>
 		<meta name="description" content="Nearguru sends service experts like you requests from customers. You decide who to respond to and send a quote. ">
            ...
            <div class="row">
                <div class="col-md-3 col-xs-6 col-sm-3">
                    <a href="${pageContext.request.contextPath}/index" class="logo"> 
                        <img src="<c:url value="/resources/assets/img/logo.png" />"  alt="Interior Design">
                    </a>
                ...
                <c:if test="${user eq null}">      
                    <ul class="social-info">       
                       ...
                       <li><a style="color:#428bca;border:0px" href="${pageContext.request.contextPath}/howItWorksPros" ><b>Why join Nearguru ?</b></a></li>
        ...
        <div class="container">   
        	<div class="row"> 
        		 <div class=" col-md-offset-2 col-md-8">
                        ...
                        <label style="font-size:56px;font-weight:bold;color:white;line-height:56px">  
                          <b> Meet new customers</b>    
                        </label>         
                        <label style="color:white;font-size:18.2px">  
                            Nearguru sends service experts  like you requests from customers. You decide who to respond to and send a quote. 
                        </label>      
            ...
            <div class="row"> 
                ...
                <div class="col-md-offset-2 col-md-5">
                    <div class="row">
                        <div class="panel panel-success" style="background-color:transparent;border:0px">
							...
							<form:form action="${pros}" commandName="userProsProfile">    
                                	<div class="form-group" >
                                		<div class="row">
                                			<div class="col-md-12">    
                                				<div>   
                                    		<label style="color:white;font-size:19.2px"><b>What do you do?</b></label>
                                   				<form:select   placeholder="Please Select category" path="productGroupId" required="required" id="docNo"  oninvalid="this.setCustomValidity(' ')" oninput="setCustomValidity('')" class="form-control invalid cursor" style="font-size:22.4px;color:#8e8e8e;height:51.8px">
							    			 			 <form:option value="" label="Please select category"/></li>
							    			 		<c:forEach items="${productGroupList}" var="productGroup">
							    			 			<form:option label="${productGroup.productGroupName}" value="${productGroup.productGroupId}" />
							    			 		</c:forEach>
							    			 	</form:select>    
							  			  
							  				</div> 
							  				<div style="margin-top:-9px"> 
                                   		 	<input type="submit"  style="background:-webkit-linear-gradient(top, #4092f1, #1a7cee);border-color: #1a7cee" class="btn btn-success btn-lg" id="btnContinue"  value="Continue"/>
                                 	     </div>
                                    </div>     
                                      ...
                                      <div class="form-group" >
                                      	<a href="${pageContext.request.contextPath}/howItWorksPros"  style="color:white;text-decoration:none;font-size:18.2px;line-height:46.2px">How Nearguru works</a>
                                      </div>   
