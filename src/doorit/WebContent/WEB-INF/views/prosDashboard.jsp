...
<html class="no-js">
 ...
 <div class="container-fluid">
   ...
   <div class="text-center bg-info text-info" style="height:60px;">       
   		<h4 style="padding-top:20px;padding-bottom:15px">You have not received any service request  Or You are not verified yet. Please call +91-9561048700 Or Email On-info@nearguru.com for more information  </h4>   
   </div>
    </c:if>
