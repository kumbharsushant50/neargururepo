    ...
    <body>
        ...
        <div class="row">  
            <div class="col-md-12 bg-color">
               <div class="container">
                   <h2 class="">  <a href="${pageContext.request.contextPath}/listBussiness" title=""><i class="fa fa-arrow-circle-o-left"></i></a> Sign up your business </h2>
               </div>
           </div>
...
<c:if test="${wrapSuccessError.suceess eq false }">
		...
		<center>${wrapSuccessError.action}</center>
                                ...
                                <div class="panel-body">
                                    ...
                                    <form:form id="proRegistration" action="${addUser}" name="proReg" commandName="userProsProfile">
         ...
         class="invalidchecbox"  path="profile.ListedIn"  value="${product.productId}" title="Select Atleast one service"/>&nbsp; ${product.productName}</li>
                         	 				</c:forEach> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <form:input  required="required"   type="text" maxlength="50" class="form-control invalid" path="profile.companyName" oninvalid="this.setCustomValidity('Please enter  company name')" oninput="setCustomValidity('')"   />                                          
                                       		 </div>
                                       		 <div class="form-group">
                                            	<label><b>Company website</b>  </label>
                                            	<form:input  class="form-control"  maxlength="100" path="profile.website"  />                                          
                                       		 </div>
                                         
                                         
                                            <div class="form-group">
                                                <label><b>Company profile</b></label>
                                                	<form:textarea  class="col-xs-12 form-control"      maxlength="500" path="profile.companyProfile" rows="4" cols="38" />

                                            </div>
                                            
                                            <div class="form-group">
                                                <label><b>Address</b></label>
                                                	<form:input  type="text"    maxLength="150" class="form-control" path="user.address" />
                                            </div>
                                            
                                            <div class="form-group">
                                                <label><b>Locality</b></label> 
                                                <div class="map_canvas"></div>
                                                <form:input id="geocomplete"  maxLength="60"  required ="required" type="text" class="form-control invalid " path="user.formatted_address" oninvalid="this.setCustomValidity('Please enter  locality')" oninput="setCustomValidity('')"  placeholder="e.g Wakad,Kalyani Nagar,Aundh" />
                                        ...
                                        <div  class="form-group clickablediv cursor">   
                                                <span >
                                              <form:radiobutton checked="checked" id="TTOC" path="profile.bussinessType" value="TTOC"/> 
                                        ...
                                        <div class="form-group clickablediv cursor">
                                                <span >
                                               <form:radiobutton id="CTOM" path="profile.bussinessType" value="CTOM"/>
                                        ...
                                        <div class="form-group clickablediv cursor">
                                                <span >
                                               <form:radiobutton id="NEITHER" path="profile.bussinessType" value="NEITHER"/> 
                                        ...
                                        <form:select  class="form-control cursor" path="profile.bussinessDistance">
                                        ...
                                        <hr>
                                        <div class="form-group">
                                            <label><b>4. Set-up your account details</b></b></label>                                   
                                        </div>
                                        <hr/>
                                        <div class="form-group"> 
                                            <label><b>Full name </b> </label>
                                            <form:input   required ="required"    maxlength="40"  class="form-control invalid" path="user.name" oninvalid="this.setCustomValidity('Please enter name')" oninput="setCustomValidity('')"  />                                           
                                        </div>
                                        <div class="form-group">
                                            <label><b>Email </b> </label>
                                            <form:input required ="required" maxlength="60" type="email"  class="form-control invalid" path="user.emailId" oninvalid="this.setCustomValidity('Please enter valid email')" oninput="setCustomValidity('')" />                                          
                                        </div>
                                        <div class="form-group">  
                                            <label><b> Mobile </b></label> 
                                            <form:input  type="text" pattern="\d*"   required="required"   id="mobileInput"   class="form-control" maxlength="10" oninvalid="this.setCustomValidity('Please enter mobile  number')" oninput="setCustomValidity('')"  path="user.mobile" />
                                            
                                            <div class="form-group"> 
                                            	<label><b>Create Password</b></label>  
                                            	<form:input  required ="required" type="password"  maxlength="15" class="form-control invalid" oninvalid="this.setCustomValidity('Please enter passowrd')"   oninput="setCustomValidity('')"  path="user.password" />
                                       		</div>
                                        	<!--  
                                        	<div class="form-group"> 
										...
										<p> By clicking Create Account, you indicate that you have read and agree to the <a style="cursor:pointer" onclick="openFooterLinks('termsOfUsage')">Terms of Use </a>and <a style="cursor:pointer" onclick="openFooterLinks('privacyPolicy')">Privacy Policy</a>.</p>  
                                             <button id="btnCreateAccount" type="submit"  onClick="check()" class="btn btn-success">Create Account</button>
                                        </div>
                                    </form:form> 
                                </div>
                        ...
                        <div class="col-md-offset-1 col-md-5">
                           <p style="font-size:24px;color:#3c7088">Why wait for a Customer to come in</p>  
                            	
								<p> <span style="background-color:#EF0D49;font-size:20px" class="badge">1</span>  Create your FREE profile </p>
								<p> <span style="background-color:#EF0D49;font-size:20px" class="badge">2</span>  Get verified and genuine leads  </p>
								<p> <span style="background-color:#EF0D49;font-size:20px" class="badge">3</span>  Send best quotations  </p>
								<p> <span style="background-color:#EF0D49;font-size:20px" class="badge">4</span>  Get hired and get paid </p>
