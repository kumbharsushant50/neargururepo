...
<head>
    ...
    <title>nearguru.com Pune - Compare quotes & prices from local business </title>
     <meta name="description" content="nearguru Pune - Find local business service providers, pest control, packers and movers, cleaning service / water tank cleaning, interior design, modular kitchen, House painter, Water proofing, plumbing & Catering service.">
            ...
            <div class="row">
                <div class="col-md-3 col-xs-6 col-sm-3">
                    <a href="${pageContext.request.contextPath}/index" class="logo"> 
                        <img src="<c:url value="/resources/assets/img/logo.png" />"  alt="Nearguru - Hire an service expert">
                    </a>
              	   
                </div>
                   <div class="fb-like col-md-3 col-xs-6 col-sm-3" data-href="https://www.facebook.com/pages/Nearguru/1591687554433559" data-layout="button" data-action="like" data-show-faces="false" data-share="true"></div>
                ...
                <c:if test="${user eq null}">     
                    <ul class="social-info">    
                       ...
                       <li><a style="color:black" href="${pageContext.request.contextPath}/listBussiness" ><b>List Your Business</b></a></li>
                     <li><a style="color:black" href="${pageContext.request.contextPath}/SignUp">Sign Up</a></li>
                     <li><a style="color:black" href="${pageContext.request.contextPath}/login">Sign In</a></li>
                 </ul>
                 </c:if>
 ...
 <div class="jumbotron" style="padding-top:55px" >
   ...
   -->
                ...
                <div class="col-xs-12 col-md-5 col-sm-5">
                    <div class="row">
                        <div class="panel panel-success ">
                            <div class="panel-heading">Compare quotes & prices from local business           
                            </div>
                            ...
                            <div class="panel-body">
								...
								<form:form action="${requestService}" id="indexform" commandName="userProsProfile">
                                	 
                                	<div class="form-group">
                                    <label><b>What service do you need?</b></label>
                                    <form:input id="w-input-search" value="" maxlength="100" required="required" path="product.productName" class="form-control input-lg col-md-4"  placeholder=" interior design , modular kitchen , packers and movers"  />
                                    </div>
									...
									<div class="map_canvas"></div>
                                     <form:input id="geocomplete"  class="form-control input-lg col-md-2"  maxlength="200" path="requestService.formatted_address" type="text" />
									...
									<div class="form-group">
                                    <input type="submit" class="btn btn-success btn-lg" id="btnContinue" value="Get FREE Quotes"/>
                                    </div>
                                </form:form>
                            </div>
                        </div>
                    ...
                    <div class="row" id="develop">    
                        ...
                        <div class="col-md-6 col-md-pull-3">  
                            ...
                            <br/>       
								...
								<li><i class="fa-li fa fa-file fa-2x  text-info"></i> <p>Quotation as an attachment file </p><br/></li>
    ...
    <div class="container-fluid" style="background-color:#dedede">    
        <div class='row'> 
            <div class='col-xs-12 col-md-offset-1 col-md-10'>
                <h1 class="title text-center" style="padding-top:30px">Popular Services</h1>
            </div> 
        </div>
        ...
        <div class="row" style="margin-left:4%">   
                <div class="col-ms-10 col-md-4">  
                    <div class="project">
                        <figure class="img-responsive">
                           <img src="<c:url value="/resources/assets/img/packers_and_movers.jpg" />" alt="Packers and Movers Service">
                            <figcaption>
                                <span class="project-details">Packers and Movers</span>  
                               
                            </figcaption>
                            <span class="actions">
                                <a href="${pageContext.request.contextPath}/popularServiceForm/2/packers-and-movers-in-pune" class="btn btn-warning bnt-action" >Request Service </a>
                            </span>
                        </figure>      
                    </div>
                </div> 
                ...
                <div class="col-ms-10 col-md-4">
                    <div class="project">
                        <figure class="img-responsive">
                           <img src="<c:url value="/resources/assets/img/interior_design_service.jpg" />" alt="Interior Design Service">
                            <figcaption>
                                <span class="project-details">Interior Design</span>
                                
                            </figcaption>    
                            <span class="actions">
                                <a href="${pageContext.request.contextPath}/popularServiceForm/13/interior-design-in-pune" class="btn btn-warning bnt-action"  >Request Service </a>
                            </span>
                        </figure>
                    </div>
                </div>
                ...
                <div class="col-ms-10 col-md-4">
                    <div class="project">
                        <figure class="img-responsive">
                            <img src="<c:url value="/resources/assets/img/modular_kithcen.jpg" />" alt="Modular Kitchen Service">
                            <figcaption> 
                                <span class="project-details">Modular Kitchen</span>
                               
                            </figcaption>
                            <span class="actions">
                                <a class="btn btn-warning bnt-action" href="${pageContext.request.contextPath}/popularServiceForm/14/modular-kitchen-in-pune" >Request Service </a>
                            </span>
                        </figure>
                    </div>
                </div>  
            ...
            <div class="row" style="margin-left:4%">  
                <div class="col-ms-10 col-md-4">
                    <div class="project"> 
                        <figure class="img-responsive">
                           <img src="<c:url value="/resources/assets/img/home_painting.jpg" />" alt="House painting Service">
                            <figcaption>
                                <span class="project-details">Interior House Painting</span>
                              
                            </figcaption>
                            <span class="actions">
                                <a class="btn btn-warning bnt-action" href="${pageContext.request.contextPath}/popularServiceForm/16/interior-house-painting-in-pune" >Request Service </a>
                            </span>
                        </figure>
                    </div>
                </div>
                ...
                <div class="col-ms-10 col-md-4">
                    <div class="project">
                        <figure class="img-responsive">
                            <img src="<c:url value="/resources/assets/img/pestcontrol.jpg" />" alt="Pest Control service">
                            <figcaption>
                                <span class="project-details">Pest Control</span>
                              
                            </figcaption>
                            <span class="actions">
                                <a class="btn btn-warning bnt-action" href="${pageContext.request.contextPath}/popularServiceForm/1/pest-control-in-pune" >Request Service </a>
                            </span>
                        </figure>
                    </div>
                </div>
                ...
                <div class="col-ms-10 col-md-4">
                    <div class="project">
                        <figure class="img-responsive"> 
                           <img src="<c:url value="/resources/assets/img/cleaning.jpg" />" alt="Home Cleaning service  ">
                            <figcaption>
                                <span class="project-details">Home Cleaning</span>
                                 
                            </figcaption>
                            <span class="actions">
                                <a class="btn btn-warning bnt-action" href="${pageContext.request.contextPath}/popularServiceForm/5/cleaning-services">Request Service </a>
                            </span>
                        </figure>
                    </div> 
                </div>
        ...
        <div class="row" style="padding-bottom:25px;margin-left:4%"> 
            <div class="col-xs-12  col-md-4"> 
                <button class="btn btn-lg btn-danger" onclick="window.location = '${pageContext.request.contextPath}/popularServices';" type="button" name="">View all Services </button>
            </div>
        </div>
    ...
    <div class="container-fluid" >         
        <div class="row">
                ...
                <article> 
                   <div class='row'>   
            <div class='col-xs-12 col-md-offset-1 col-md-10' style="margin-bottom:2%">
                <h1 class="title text-center">Why use NearGuru </h1> 
                <div class="row" style="margin-bottom:3%">                  
                             
                     <div class="col-md-3" style="text-align:center"> <i class="fa fa-money fa-4x text-danger" ></i><p class="text-cont">Free to use</p></div>
                     <div class="col-md-3" style="text-align:center"> <i class="fa fa-dropbox fa-4x  text-danger" ></i><p class="text-cont">No obligation to hire</p></div>
                     
                <div class="col-md-3" style="text-align:center"> <i class="fa fa-tachometer fa-4x  text-danger" ></i><p class="text-cont">Personal Dashboard</p></div>
                  
                                   
                <div class="col-md-3" style="text-align:center"> <i class="fa fa-inr fa-4x  text-danger" ></i><p class="text-cont">Online Quotes and Best Price</p></div>
                    
                </div>
                     <div class="row" >                         
                      <div class="col-md-3" style="text-align:center"> <i class="fa fa-users fa-4x  text-danger" ></i><p class="text-cont">100% verified and trusted professional</p></div>    
                  <div class="col-md-3" style="text-align:center"> <i class="fa fa-globe fa-4x  text-danger" ></i><p class="text-cont">One stop destination</p></div>  
                
                <div class="col-md-3" style="text-align:center"> <i class="fa fa-clock-o fa-4x  text-danger" ></i><p class="text-cont">Saves your time</p></div>                 
                       <div class="col-md-3" style="text-align:center"> <i class="fa fa-check-square fa-4x  text-danger" ></i><p class="text-cont">Best Quality</p></div>      
