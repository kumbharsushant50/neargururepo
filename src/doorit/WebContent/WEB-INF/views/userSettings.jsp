...
<form:form action="${userSettings}" commandName="userSettings">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <form:input path="name"    maxlength="40"  required="required" class="form-control invalid"  oninvalid="this.setCustomValidity('Please enter name')" oninput="setCustomValidity('')"  />
									...
									<form:input path="emailId"  type="email" maxlength="50" class="form-control invalid" required="required" oninvalid="this.setCustomValidity('Please enter valid email')" oninput="setCustomValidity('')"  />
										...
										<form:input path="mobile" type="text" pattern="\d*"  class="form-control"  maxlength="12"  oninvalid="this.setCustomValidity('Please enter  valid mobile number')" oninput="setCustomValidity('')"   />
                                         ...
                                         <div class="form-group"> 
                                            ...
                                            <form:input path="address"    maxlength="150" class="form-control"  />
                                        </div>
                                ...
                                <form:form action="${password}" commandName="userSettings">
                                    <fieldset>                           
                                        <div class="form-group"> 
                                            ...
                                            <form:input  maxlength="15"   type="password" class="form-control invalid" path="password" required="required"  oninvalid="this.setCustomValidity('Please enter passowrd')"  oninput="setCustomValidity('')"/>
                                        </div>
        ...
        <section style="margin-bottom:20px;">
            <div class="row">
                ...
                <p>Want to close your account?
                    Call +91-9561048700 or email info@nearguru.com and we'll cancel your account.
                </p>
            </div>
        </section>
